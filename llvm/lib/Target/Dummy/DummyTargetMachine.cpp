//===-- DummyTargetMachine.cpp - Define TargetMachine for Sparc -----------===//
//
...
extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeSparcTarget() {
  // Register the target.
  RegisterTargetMachine<DummyV8TargetMachine> X(getTheSparcTarget());
  RegisterTargetMachine<DummyV9TargetMachine> Y(getTheSparcV9Target());
...
DummyTargetMachine::DummyTargetMachine(const Target &T, const Triple &TT,
...
DummyTargetMachine::~DummyTargetMachine() = default;
...
MachineFunctionInfo *DummyTargetMachine::createMachineFunctionInfo(
    BumpPtrAllocator &Allocator, const Function &F,
    const TargetSubtargetInfo *STI) const {
  return DummyMachineFunctionInfo::create<DummyMachineFunctionInfo>(Allocator,
                                                                    F, STI);
}
...
namespace {
	...
	class DummyPassConfig : public TargetPassConfig {
		public:
		  SparcPassConfig(DummyTargetMachine &TM, PassManagerBase &PM)
			: TargetPassConfig(TM, PM) {}

		  DummyTargetMachine &getSparcTargetMachine() const {
...
bool DummyPassConfig::addInstSelector() {
  //probably has to be imported from somewhere
